...
const PricingTier = ({
  ...
  isPopular?: boolean;
    ...
    <div className="relative h-full p-6 flex flex-col bg-slate-50">
      {isPopular && <motion.span initial={{
      opacity: 0,
      scale: 0.8
    }} animate={{
      opacity: 1,
  ...
  return <section className="container px-4 py-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        delay: 0.1
          ...
          <PricingTier name="Starter Package" price="$40,240" description="Model 3 + Basic Crypto Portfolio" features={["Big Green Model 3", "272 miles range", "Basic crypto tracking", "Email support"]} />
        </motion.div>
        <motion.div initial={{
        opacity: 0,
        y: 30
        ...
        delay: 0.2
          ...
          <PricingTier name="Pro Package" price="$52,990" description="Model Y + Advanced Trading Tools" features={["Big Green Model Y", "330 miles range", "Advanced trading tools", "Portfolio analytics", "Priority support"]} isPopular />
        </motion.div>
        <motion.div initial={{
        opacity: 0,
        y: 30
        ...
        delay: 0.3
          ...
          <PricingTier name="Elite Package" price="$88,490" description="Model S + Premium Investment Suite" features={["Big Green Model S", "405 miles range", "AI-powered trading", "Dedicated advisor", "Custom API access", "24/7 concierge"]} />
        </motion.div>
      </div>
    </section>;
};