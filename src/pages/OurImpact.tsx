      ...
      >
        <div className="container max-w-7xl px-2 sm:px-4">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter leading-tight mb-6">
            OUR <span className="highlight-yellow">IMPACT</span>
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-foreground/70 leading-relaxed max-w-4xl">
            Big Green has impacted hundreds of thousands of lives across America through our garden programs. 
            We've helped build community gardens, supported home growers, and created sustainable food systems 
