    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      >
        <div className="container max-w-7xl relative z-10 px-2 sm:px-4 text-center">
          ...
          >
            DISCOVER WHAT MAKES <span className="highlight-yellow">BIG GREEN</span> SPECIAL
          </motion.h1>
          ...
          >
            Explore all the ways we help you grow food, access grants, and invest in a sustainable future
          </motion.p>
        </div>
      </motion.section>
