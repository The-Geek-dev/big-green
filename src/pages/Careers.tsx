      ...
      >
        <div className="container max-w-7xl px-2 sm:px-4">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter leading-tight mb-6">
            WORK AT <span className="highlight-yellow">BIG GREEN</span>
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-foreground/70 leading-relaxed max-w-4xl">
            Join our mission to get everyone in America growing food. We're always looking for passionate individuals 
            who want to make a real difference in their communities. Explore current opportunities and learn what it's 
            like to work at Big Green.
          </p>
        </div>
      </motion.section>
