...
const applicationSchema = z.object({
  ...
  tier: z.enum(["tier1", "tier2", "tier3"], { required_error: "Please select a tier" }),
        ...
        >
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-black mb-4">
              Investment Tier <span className="text-gradient">Application</span>
            </h1>
            <p className="text-lg text-muted-foreground">
              Complete the form below to apply for your Big Green investment tier
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="message"
                  name="message"
                  placeholder="Tell us more about your interest in Big Green and sustainable investing..."
