      ...
      >
        <div className="container max-w-7xl px-2 sm:px-4">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter leading-tight mb-6">
            OUR <span className="highlight-yellow">TEAM</span>
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-foreground/70 leading-relaxed max-w-4xl">
            Meet the passionate individuals behind Big Green. Our team is dedicated to creating a world where everyone 
            has access to fresh, healthy food and the knowledge to grow it. From program managers to garden educators, 
            we're all committed to our mission.
          </p>
        </div>
      </motion.section>
