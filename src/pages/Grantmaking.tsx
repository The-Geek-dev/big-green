      ...
      >
        <div className="container max-w-7xl px-2 sm:px-4">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter leading-tight mb-6">
            <span className="highlight-yellow">GRANTMAKING</span>
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-foreground/70 leading-relaxed max-w-4xl">
            Our grantmaking program distributes funding to individuals, schools, businesses, and housing communities 
            committed to growing food and building sustainable communities. Learn about our grant criteria, application 
            process, and success stories from our grantees.
          </p>
        </div>
      </motion.section>
